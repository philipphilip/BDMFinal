...
public class ValidateTheCODFormInEregistry {
	...
	public static void Execute(WebDriver driver) throws Throwable {
		...
		EregistryControls.validateItem(EregistryControls.validationErrorRow1,"Given Names is required.","Deceased Details - Given Names");
		...
		EregistryControls.validateItem(EregistryControls.validationErrorRow17,"Given Names is required.","Deceased Details - Given Names");
