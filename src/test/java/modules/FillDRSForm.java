...
public class FillDRSForm {
	...
	public static void Execute(WebDriver driver) throws Throwable {
		...
		Helper.selectDropDownList(CoreDRSPage.Sex, "Male");
		...
		Helper.selectDropDownList(CoreDRSPage.aboriginalOrTorresStraitIslanderOrigin, "Neither Aboriginal or Torres Strait Islander");
