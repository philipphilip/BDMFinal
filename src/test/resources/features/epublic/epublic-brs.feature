...
Feature: ePublic brs
  ...
  Scenario: ePublic create brs and submit to core
    ...
    And I can see "This Birth Registration Statement has been successfully saved" on "BRS" page of "epublic"
    ...
    And I click "Continue" button on "popup" page of "BRS" in "epublic"
